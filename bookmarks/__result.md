...
* felixg.io - Javascript and jQuery libraries and Material UI components. <https://felixg.io/products>
...
* AddyOsmani.com - Learning JavaScript Design Patterns - An Updated Free Book For Developers <https://addyosmani.com/blog/learning-javascript-design-patterns/>
...
* Design Thinking: Study Guide <https://www.nngroup.com/articles/design-thinking-study-guide/>
...
* 15+ Expert Resources For Mobile UI Inspiration: Patterns, Components and Flows by Stéphanie Walter - UX Researcher & Designer. <https://stephaniewalter.design/blog/15-resources-for-mobile-ui-inspiration-patterns-components-and-flows/>
* Learn Responsive Design <https://web.dev/learn/design/>
* Why white looks bigger than black — The irradiation illusion | by Gonçalo Dias | Nov, 2021 | UX Collective <https://uxdesign.cc/why-white-looks-bigger-than-black-the-irradiation-illusion-935dc634bb42>
* Design for internationalization. Build better products for people around… | by John Saito | Dropbox Design | Medium <https://medium.com/dropbox-design/design-for-internationalization-24c12ea6b38f>
...
* Books - DesignBetter <https://www.designbetter.co/books>
...
* Building a design system with Eleventy | Trys Mudford <https://www.trysmudford.com/blog/eleventy-design-system/>
...
* Email Design Inspiration by HTML Email Designs <http://htmlemaildesigns.com/>
* Blog | Mailgun <https://www.mailgun.com/blog/>
...
* The 97 Best Email Marketing Campaign Examples | Campaign Monitor <https://www.campaignmonitor.com/best-email-marketing-campaigns/>
...
*  **DUP** How to Target Email Clients <https://howtotarget.email/>
...
* EmailComb - Removes unused CSS from email templates <https://emailcomb.com/light/>
* Newsletters spam test by mail-tester.com <https://www.mail-tester.com/>
* Free Email Spam Test - Check Email for Spam | GlockApps <https://glockapps.com/spam-testing/>
* About | Buttondown <https://buttondown.email/>
* New to email coding? Here’s where to start. | by Caity G. O'Connor | Really Good Emails <https://explore.reallygoodemails.com/new-to-email-coding-heres-where-to-start-2494422f0bd4>
...
* Airtable - Grid view <https://airtable.com/shrJxffTnSHSdIwqN/tbltBA3AOkEaVg8wO>
*  **DUP** How to Target Email Clients <https://howtotarget.email/>
* hteumeuleu/email-bugs: Email quirks and bugs <https://github.com/hteumeuleu/email-bugs>
* Build a Free HTML email template in less than 60 seconds | Campaign Monitor <https://www.campaignmonitor.com/email-templates/>
...
* Everything Developers Need To Know About Figma — Smashing Magazine <https://www.smashingmagazine.com/2020/09/figma-developers-guide/>
* Creating design systems with Figma Tokens | by Marc Andrew | Nov, 2021 | UX Collective <https://uxdesign.cc/creating-design-systems-with-figma-tokens-31686b8d672e>
* Free Resources for Designers and Developers - Freebiesbug <https://freebiesbug.com/>
* Building Workbench. How we created the Timeline component | by Josh Cusick | Gusto Design | Jul, 2022 | Medium <https://medium.com/gusto-design/building-workbench-b7b6a232508b>
* Prototyper – Figma <https://www.figma.com/community/plugin/1094357790584717676/Prototyper>
* CopyPalette | Seamless color palette generation <https://copypalette.app/>
* Google Font Pairings <https://www.figma.com/google-fonts/>
* Glyphs - The Complete Icon Design System <https://glyphs.fyi/>
* Advanced Figma components tips & tricks: little gems we love | by Christine Vallaure | Apr, 2023 | UX Collective <https://uxdesign.cc/advanced-figma-components-tips-tricks-little-gems-we-love-27c276130e9f>
* The ultimate guide to breakpoints and flexbox in Figma | by Chuck Rice | UX Collective <https://uxdesign.cc/the-ultimate-guide-to-breakpoints-and-flexbox-in-figma-7598d8a4b461>
* Free and open-source SVG Icons - Flowbite <https://flowbite.com/icons/>
* Getting started with native design tokens in Figma | by Lukas Oppermann | Jun, 2023 | UX Collective <https://uxdesign.cc/getting-started-with-native-design-tokens-in-figma-5d9c5fcdd9f7>
* The big problem with variables in Figma | by Paavan | Jul, 2023 | UX Collective <https://uxdesign.cc/the-big-problem-with-variables-in-figma-61a4ea82640>
...
* Diffchecker - Online diff tool to compare text to find the difference between two text files <https://www.diffchecker.com/diff>
...
* typicode/husky: Modern native Git hooks made easy 🐶 woof! <https://github.com/typicode/husky>
* gitignore.io - Create Useful .gitignore Files For Your Project <https://toptal.com/developers/gitignore>
...
* The React Handbook – freeCodeCamp.org <https://medium.freecodecamp.org/the-react-handbook-b71c27b0a795>
* BBC World Service & Web Performance | by Chris Hinds | BBC Design + Engineering | Medium <https://medium.com/bbc-design-engineering/bbc-world-service-web-performance-26b08f7abfcc>
...
* ironboy/react-amazing-proxy: The npm package react-amazing proxy is an amazing proxy for use with create-react-app. It lets you use your own backend api, with web sockets and server sent events working, watches your backend api code for changes, and can switch to serve your production build. <https://github.com/ironboy/react-amazing-proxy#readme>
* How to Correctly Debounce and Throttle Callbacks in React <https://dmitripavlutin.com/react-throttle-debounce/>
*  **DUP** Handling multiple pages with the external component React Router DOM - DEV Community <https://dev.to/eduardo_alvarez_946ae8b20/handling-multiple-pages-with-the-external-component-react-router-dom-50fe>
...
* How to Integrate React In Symfony Web Encore. <https://www.cloudways.com/blog/symfony-react-using-webpack-encore/>
* React Preview | React Preview <https://reactpreview.com/>
* How To Share State Across React Components with Context | DigitalOcean <https://www.digitalocean.com/community/tutorials/how-to-share-state-across-react-components-with-context>
* PropTypes in React: A complete guide - LogRocket Blog <https://blog.logrocket.com/validating-react-component-props-with-prop-types-ef14b29963fc/>
...
* React Router v5: The Complete Guide - SitePoint <https://www.sitepoint.com/react-router-complete-guide/>
* How To Handle Routing in React Apps with React Router | DigitalOcean <https://www.digitalocean.com/community/tutorials/how-to-handle-routing-in-react-apps-with-react-router>
...
* Handling runtime environment variables in create-react-apps | @RisingStack <https://blog.risingstack.com/create-react-app-runtime-env-cra/>
...
* Planby - React Electronic Program Guide <https://planby.netlify.app/>
* Getting Started – React Spectrum <https://react-spectrum.adobe.com/react-spectrum/getting-started.html>
* Aspect — Build UI, fast <https://aspect.app/>
* react-cropper/react-cropper: Cropperjs as React component <https://github.com/react-cropper/react-cropper>
* Building a carousel component in React using Hooks - LogRocket Blog <https://blog.logrocket.com/building-carousel-component-react-hooks/>
...
* Introduction · React in patterns <https://krasimir.gitbooks.io/react-in-patterns/content/>
...
*  **DUP** uidotdev/usehooks: Easy to understand React Hook code recipes <https://github.com/uidotdev/usehooks>
...
* Storing Multiple Elements in a Single Ref in React | Sean C Davis <https://www.seancdavis.com/posts/storing-multiple-elements-in-a-single-ref-in-react/>
* React Hooks — useObserve (use ResizeObserver Custom Hook) | by Eyas Mattar | Medium <https://eymas.medium.com/react-hooks-useobserve-use-resizeobserver-custom-hook-45ec95ad9844>
...
* Fix the "Function makes the dependencies of useEffect Hook change on every render" warning in React | TypeOfNaN <https://typeofnan.dev/fix-function-makes-the-dependencies-of-useEffect-hook-change-on-every-render-warning-in-react/>
* Loaders | UI Ball <https://uiball.com/loaders/>
...
* Handling external and internal refs to the same element with useImperativeHandle in React | by Assaf Packin | Vimeo Engineering Blog | Medium <https://medium.com/vimeo-engineering-blog/handling-internal-and-external-refs-to-the-same-element-with-useimperativehandle-in-react-746ff6d377fe>
* React dynamic imports and route-centric code splitting - LogRocket Blog <https://blog.logrocket.com/react-dynamic-imports-route-centric-code-splitting-guide/>
* React Redux | React Redux <https://react-redux.js.org/>
* An Introduction To Context Propagation In JavaScript — Smashing Magazine <https://www.smashingmagazine.com/2022/08/react-context-propagation-javascript/>
...
*  **DUP** uidotdev/usehooks: A collection of modern, server-safe React hooks – from the ui.dev team <https://github.com/uidotdev/usehooks>
* Getting Started with React DevTools in Chrome | DebugBear <https://www.debugbear.com/blog/react-devtools>
* How to Use TypeScript in React Apps <https://www.freecodecamp.org/news/using-typescript-in-react-apps/>
* How to Use React Hooks – Full Tutorial for Beginners <https://www.freecodecamp.org/news/full-guide-to-react-hooks/>
...
* TanStack/query: 🤖 Powerful asynchronous state management, server-state utilities and data fetching for the web. TS/JS, React Query, Solid Query, Svelte Query and Vue Query. <https://github.com/TanStack/query>
...
* WebAIM: Creating Accessible Forms - Advanced Form Labeling <https://webaim.org/techniques/forms/advanced>
...
* A Lightweight Masonry Solution | CSS-Tricks <https://css-tricks.com/a-lightweight-masonry-solution/>
* Modern CSS Solutions <https://moderncss.dev/>
* How to Overlap Images in CSS | Bri Camp Gomez <https://bricampgomez.com/blog/how-to-overlap-images-in-css/>
* Approaches for a CSS Masonry Layout | CSS-Tricks <https://css-tricks.com/piecing-together-approaches-for-a-css-masonry-layout/>
* List Style Recipes | CSS-Tricks <https://css-tricks.com/list-style-recipes/>
* Bold on Hover... Without the Layout Shift | CSS-Tricks <https://css-tricks.com/bold-on-hover-without-the-layout-shift/>
...
* Styling Complex Labels - Cloud Four <https://cloudfour.com/thinks/styling-complex-labels/>
...
* CSS breakpoints used by CSS frameworks <https://polypane.app/blog/css-breakpoints-used-by-popular-css-frameworks/>
...
*  **DUP** CSS Font Stack: Web Safe and Web Font Family with HTML and CSS code. <https://www.cssfontstack.com/>
...
* Entertainment - Fonts In Use <https://fontsinuse.com/in/1/topics/21/entertainment>
* Lineto.com <https://lineto.com/typefaces>
...
* lea verou CSS.coloratum <https://leaverou.github.io/css-colors/>
...
* Name that Color - Chirag Mehta : chir.ag <http://chir.ag/projects/name-that-color/>
...
* Negative margins in CSS - QuirksBlog <https://www.quirksmode.org/blog/archives/2020/02/negative_margin.html>
* space <https://css-tricks.com/a-complete-guide-to-calc-in-css/>
...
* 5 most annoying website features I face as a blind person every single day | The Big Hack <https://bighack.org/5-most-annoying-website-features-i-face-as-a-blind-screen-reader-user-accessibility/>
...
* Writing even more CSS with Accessibility in Mind, Part 2: Respecting user preferences - Manuel Matuzović <https://www.matuzo.at/blog/writing-even-more-css-with-accessibility-in-mind-user-preferences/>
* How to build a progressively enhanced accordion component with vanilla JS | Go Make Things <https://gomakethings.com/how-to-build-a-progressively-enhanced-accordion-component-with-vanilla-js/>
...
* CSS { In Real Life } | A Utility Class for Covering Elements <https://css-irl.info/a-utility-class-for-covering-elements/>
...
* Add scroll margin to all elements which can be targeted - Quick Tip - Piccalilli <https://piccalil.li/quick-tip/add-scroll-margin-to-all-elements-which-can-be-targeted>
...
* Tips for Focus Styles - Nic Chan <https://www.nicchan.me/blog/tips-for-focus-styles/>
...
* CSS Switch-Case Conditions | CSS-Tricks <https://css-tricks.com/css-switch-case-conditions/>
...
* :where() has a cool specificity trick, too. | CSS-Tricks <https://css-tricks.com/where-has-a-cool-specificity-trick-too/>
* Good, Better, Best: Untangling The Complex World Of Accessible Patterns — Smashing Magazine <https://www.smashingmagazine.com/2021/03/good-better-best-untangling-complex-world-accessible-patterns/>
* Taming Blend Modes: `difference` and `exclusion` | CSS-Tricks <https://css-tricks.com/taming-blend-modes-difference-and-exclusion/>
* Digging Into CSS Logical Properties <https://ishadeed.com/article/css-logical-properties/>
* constverum/stylelint-config-rational-order: Stylelint config that sorts related property declarations by grouping together in the rational order <https://github.com/constverum/stylelint-config-rational-order>
...
* The Cursors! <https://codepen.io/chriscoyier/pen/uCwfB>
* CSS content and attr <https://davidwalsh.name/css-content-attr>
* A Guide To Newly Supported, Modern CSS Pseudo-Class Selectors — Smashing Magazine <https://www.smashingmagazine.com/2021/04/guide-supported-modern-css-pseudo-class-selectors/>
* Practical Use Cases For CSS Variables - Ahmad Shadeed <https://ishadeed.com/article/practical-css-variables/>
...
* Paratype.com — excellent fonts for your project <https://www.paratype.com/>
* Recursive Sans & Mono <https://www.recursive.design/>
* ETC - Etcetera Type Company <https://www.etceteratype.co/grandstander>
...
* Optical size, the hidden superpower of variable fonts – Pixelambacht <https://pixelambacht.nl/2021/optical-size-hidden-superpower/>
* Zoom Pro | The Designers Foundry <https://thedesignersfoundry.com/zoom-pro>
* CSS { In Real Life } | Detecting Hover-Capable Devices <https://css-irl.info/detecting-hover-capable-devices/>
* 100+ Portraits Pictures | Download Free Images on Unsplash <https://unsplash.com/s/photos/portraits>
* Using HSL Colors In CSS — Smashing Magazine <https://www.smashingmagazine.com/2021/07/hsl-colors-css/>
* DJR | David Jonathan Ross <https://djr.com/>
* Inigo Quilez :: fractals, computer graphics, mathematics, shaders, demoscene and more <https://iquilezles.org/www/articles/fbmsdf/fbmsdf.htm>
* Custom properties and @property - QuirksBlog <https://www.quirksmode.org/blog/archives/2021/07/custom_properti.html>
* Rubik - Google Fonts <https://fonts.google.com/specimen/Rubik>
* EasyReading – FREE FONT <http://www.easyreading.it/it/>
* A guide to designing accessible, WCAG-compliant focus indicators <https://www.sarasoueidan.com/blog/focus-indicators/>
* Truculenta - Google Fonts <https://fonts.google.com/specimen/Truculenta>
* Barlow: A grotesk font superfamily by Jeremy Tribby <https://tribby.com/fonts/barlow/>
...
* CSS @​supports rules to target only Firefox / Safari / Chromium – Bram.us <https://www.bram.us/2021/06/23/css-at-supports-rules-to-target-only-firefox-safari-chromium/>
...
* Maggie Enterrios <https://www.littlepatterns.com/>
* Typographica <https://typographica.org/>
* Brody Fonts on Type Network <https://brodyfonts.typenetwork.com/>
* Inter font family <https://rsms.me/inter/>
* overscroll-behavior | CSS-Tricks - CSS-Tricks <https://css-tricks.com/almanac/properties/o/overscroll-behavior/>
* freefontsfamily <https://freefontsfamily.com/about-us/>
* Rosetta - Adapter PE <https://rosettatype.com/AdapterPE>
* basementstudio/basement-grotesque: The basement grotesque typeface <https://github.com/basementstudio/basement-grotesque>
...
* The Parisianer <http://www.theparisianer.eu/>
* A Complete Guide to CSS Cascade Layers | CSS-Tricks - CSS-Tricks <https://css-tricks.com/css-cascade-layers/>
* Control CSS cascade with cascade layers - LogRocket Blog <https://blog.logrocket.com/control-css-cascade-with-cascade-layers/>
* Stem — Paratype.com <https://www.paratype.com/fonts/pt/stem>
...
* Features <https://ilovetypography.com/OpenType/opentype-features.html>
* Typography 101 | I Love Typography <https://fonts.ilovetypography.com/typography-101>
...
* Device/Rian Hughes <https://www.devicefonts.co.uk/catalogue/paralucent>
* Forced colors explained: A practical guide | Polypane, The browser for ambitious developers <https://polypane.app/blog/forced-colors-explained-a-practical-guide/>
* Flexibly Centering an Element with Side-Aligned Content – Eric’s Archived Thoughts <https://meyerweb.com/eric/thoughts/2022/04/26/flexibly-centering-an-element-with-side-aligned-content/>
...
* Color Contrast Accessibility Checker (WCAG) <https://contrastchecker.online/>
* Compress, convert and optimize images online in PNG, JPEG, SVG, AVIF, WebP and GIF formats <https://www.optimizeimages.com/>
* CropScore: An Online Image Cropper for Content Creators <https://cropper.madza.dev/>
* systemfontstack (browser default fonts) <https://systemfontstack.com/>
* Lenbachhaus - Collection Online <https://www.lenbachhaus.de/en/discover/collection-online>
* Better scrolling through modern CSS <https://blog.mayank.co/better-scrolling-through-modern-css>
* CSS Reset <https://gist.github.com/EllyLoel/4ff8a6472247e6dd2315fd4038926522>
* css-modules/css-modules: Documentation about css-modules <https://github.com/css-modules/css-modules>
* The Unlocked Possibilities of the :has() Selector - Jim Nielsen’s Blog <https://blog.jim-nielsen.com/2022/unlocked-possibilities-of-has-selector/>
...
* The Infinite Marquee | Ryan Mulligan <https://ryanmulligan.dev/blog/css-marquee/>
...
* Yrsa & Rasa – open-source fonts for Latin + Gujarati <http://github.rosettatype.com/yrsa-rasa/>
* Rosetta <https://rosettatype.com/>
...
* Browse Fonts - Google Fonts <https://fonts.google.com/?query=Igino+Marini>
...
* Optical Size And Variable Fonts <https://www.robinrendle.com/notes/optical-size-and-variable-font-defaults/>
* Accessible color for design systems just got easier | by Nate Baldwin | Medium <https://medium.com/@NateBaldwin/accessible-color-for-design-systems-just-got-easier-40e8420a8371>
...
* Creating contrast-based themes with Leonardo | by Nate Baldwin | UX Collective <https://uxdesign.cc/creating-contrast-based-themes-with-leonardo-32b6219a090f>
* Adaptive Color in Design Systems. Part one | by Nate Baldwin | Thinking Design | Medium <https://medium.com/thinking-design/adaptive-color-in-design-systems-7bcd2e664fa0>
* Introducing Adaptive Color Palettes | by Nate Baldwin | Thinking Design | Medium <https://medium.com/thinking-design/introducing-adaptive-color-palettes-111b5842fc88>
* Adaptive Color in Spectrum, Adobe’s Design System | by Nate Baldwin | Thinking Design | Medium <https://medium.com/thinking-design/adaptive-color-in-spectrum-adobes-design-system-feeeec89a2c7>
* Colorimetry and the Cartography of Color | by Nate Baldwin | Thinking Design | Medium <https://medium.com/thinking-design/colorimetry-and-the-cartography-of-color-415ef5315c0a>
* Color scales for data visualization in Leonardo | by Nate Baldwin | Medium <https://medium.com/@NateBaldwin/color-scales-for-data-visualization-in-leonardo-bf206feb61b9>
* Resetting Inherited CSS with “Revert” – Cloud Four <https://cloudfour.com/thinks/resetting-inherited-css-with-revert/>
* Don't Fight the Cascade, Control It! | CSS-Tricks - CSS-Tricks <https://css-tricks.com/dont-fight-the-cascade-control-it/>
...
* The Little Book of Accessibility. If I had a TARDIS and could travel back… | by Gareth Ford Williams | UX Collective <https://uxdesign.cc/the-little-book-of-accessibility-a9b59d82b412>
...
* Una serie di video-lezioni per imparare a disegnare i Kamon, gli stemmi di famiglia giapponesi - Frizzifrizzi <https://www.frizzifrizzi.it/2022/11/08/una-serie-di-video-lezioni-per-imparare-a-disegnare-i-kamon-gli-stemmi-di-famiglia-giapponesi/>
...
* alex-page/a11ycolor: 🌈 Generate the nearest accessible color <https://github.com/alex-page/a11ycolor>
* Resources - The A11Y Project <https://www.a11yproject.com/resources/>
* Tree views in CSS <https://iamkate.com/code/tree-views/>
* Available Online, Book & Magazine Posters, Penfield, Edward | Library of Congress <https://www.loc.gov/search/?c=150&fa=subject%3Abook+%26+magazine+posters%7Ccontributor%3Apenfield%2C+edward&st=list>
...
* Readability – Fonts Knowledge - Google Fonts <https://fonts.google.com/knowledge/readability_and_accessibility>
* FONT GUIDE – THERE’S NOTHING COMIC ABOUT DYSLEXIA <https://www.nothingcomicaboutdyslexia.com/font-guide>
* CSS Style Queries - Ahmad Shadeed <https://ishadeed.com/article/css-container-style-queries/>
* CSS Cursors! <https://csscursor.info/>
* CSS color functions and custom properties - Manuel Matuzović <https://www.matuzo.at/blog/2023/hsl-custom-properties/>
* 3D in CSS <https://garden.bradwoods.io/notes/css/3d>
* P. C. M. 0.25 <https://colormixer.web.app/01332971ff6230078181285555610300/Sunset>
* AVIF Converter - unlimited free conversions | avif.io ✨ <https://avif.io/>
* Sibling Scopes in CSS, thanks to :has() – Bram.us <https://www.bram.us/2023/01/12/sibling-scopes-in-css-thanks-to-has/>
* Onest font <https://onest.md/en>
* GitHub - github/hubot-sans: Hubot Sans, a variable font from GitHub <https://github.com/github/hubot-sans>
...
* The Vignelli Canon | Lars Müller Publishers <https://www.lars-mueller-publishers.com/vignelli-canon>
* Massimo Vignelli | MoMA <https://www.moma.org/artists/6155#works>
* The Vignelli Canon: a design classic from the last of the modernists | by David Hall | Dec, 2022 | UX Collective <https://uxdesign.cc/the-vignelli-canon-a-design-classic-from-the-last-of-the-modernists-74d6e7dc0169>
* Epilogue - Google Fonts <https://fonts.google.com/specimen/Epilogue>
* Encode Sans - Google Fonts <https://fonts.google.com/specimen/Encode+Sans>
* Blending Modes | Dan Hollick 🇿🇦 <https://typefully.com/DanHollick/KrBa0JP>
* CSS Color Spaces and Relative Color Syntax | 12 Days of Web <https://12daysofweb.dev/2022/css-color-spaces-relative-color-syntax/>
* Reber R41 - Italian Masters of Iconic Fonts and Graphics since 1960 <https://r41.it/>
* I poster dei numeri primi di Nicholas Rougeux - Frizzifrizzi <https://www.frizzifrizzi.it/2023/01/31/i-poster-dei-numeri-primi-di-nicholas-rougeux/>
* Pattern Design - Royalty-Free Seamless Vector Patterns <https://www.patterndesigns.com/en>
* Iconographic Encyclopædia of Science, Literature, and Art <https://www.c82.net/iconography/>
* Modern Illustration <https://www.modernillustration.org/>
* HistoryMaps | Learn History Visually with Maps and Timelines <https://history-maps.com/>
* Improved font fallbacks - Chrome Developers <https://developer.chrome.com/blog/font-fallbacks/>
...
* Martian Grotesk at Evil Martians <https://evilmartians.com/products/martian-grotesk>
* Everything You Need to Know About the Gap After the List Marker | CSS-Tricks - CSS-Tricks <https://css-tricks.com/everything-you-need-to-know-about-the-gap-after-the-list-marker/>
* Selecting previous siblings with CSS :has() | Tobias Ahlin <https://tobiasahlin.com/blog/previous-sibling-css-has/>
* Relative rounded corners - Set Studio <https://set.studio/relative-rounded-corners/>
...
* Mastering CSS Blend Modes | Koding Kitty <https://www.kodingkitty.com/blog/blend-modes/>
*  **DUP** Free Online Database Diagram Tool <https://databasediagram.com/>
* Bookmarklet Maker <https://caiorss.github.io/bookmarklet-maker/>
* Comic Mono | comic-mono-font <https://dtinth.github.io/comic-mono-font/>
* Pricing <https://calltoinspiration.com/category/6443e32f1cd3be1a314889ad>
* Tesori d'archivio: i poster di fine '800 e inizio '900 della Ault & Wiborg, azienda di inchiostri da stampa - Frizzifrizzi <https://www.frizzifrizzi.it/2023/06/29/tesori-darchivio-i-poster-di-fine-800-e-inizio-900-della-ault-wiborg-azienda-di-inchiostri-da-stampa/>
* Magnus von Wright Images | Free Vectors, PNGs, Mockups & Backgrounds - rawpixel <https://www.rawpixel.com/search?page=1&sort=curated&tags=%24magnusvonwright&topic=%24magnusvonwright&topic_group=%24publicdomain>
* Brutalia : Build Your Own Brutalist Italy - by Zupagrafika <https://www.zupagrafika.com/shop/brutalia>
* Positioning anchored popovers | hidde.blog <https://hidde.blog/positioning-anchored-popovers/>
* Design System Canvas — Download Now! <https://designsystemcanvas.com/>
* Be careful with ch units ✣ S.Bistrović <https://www.silvestar.codes/articles/be-careful-with-ch-units/>
* An introduction to @scope in CSS <https://fullystacked.net/posts/scope-in-css/>
* CUBE CSS | CUBE CSS <https://cube.fyi/>
* Container Query Units and Fluid Typography | Modern CSS Solutions <https://moderncss.dev/container-query-units-and-fluid-typography/>
...
* Diagonal Layouts in 2023 <https://codepen.io/enbee81/pen/MWPwMMJ>
* Can you create beautiful stroked text in CSS? - LogRocket Blog <https://blog.logrocket.com/create-beautiful-stroked-text-css>
* My favourite 3 lines of CSS - Andy Bell <https://andy-bell.co.uk/my-favourite-3-lines-of-css/>
* CSS { In Real Life } | Resizing with CSS <https://css-irl.info/resizing-with-css/>
* Container Queries and Typography <https://robinrendle.com/notes/container-queries-and-typography/>
* The Power of CSS Blend Modes – Cloud Four <https://cloudfour.com/thinks/the-power-of-css-blend-modes/>
...
* Simplified Dark Mode With Style Queries | Stephanie Eckles <https://thinkdobecreate.com/articles/simplified-dark-mode-with-style-queries/>
* Picture perfect images with the modern <img> element - Stack Overflow Blog <https://stackoverflow.blog/2022/12/27/picture-perfect-images-with-the-modern-element/>
* Understanding Layout Algorithms <https://www.joshwcomeau.com/css/understanding-layout-algorithms/>
* The evolution of scalable CSS <https://frontendmastery.com/posts/the-evolution-of-scalable-css/>
* pmndrs market - Models <https://market.pmnd.rs/>
...
* An introduction to inclusive design | Nomensa <https://www.nomensa.com/blog/introduction-inclusive-design/>
* Designing for people with dyscalculia and low numeracy - Design in government <https://designnotes.blog.gov.uk/2022/11/28/designing-for-people-with-dyscalculia-and-low-numeracy/>
* Die Quelle: Flächen Schmuck (The Source: Ornament for Flat Surfaces) - Artvee <https://artvee.com/books/die-quelle-flachen-schmuck-the-source-ornament-for-flat-surfaces/>
* Free Faces <https://www.freefaces.gallery/>
* Outward <https://www.freefaces.gallery/typefaces/outward>
* Tesori d'archivio: i meravigliosi insetti di Séguy - Frizzifrizzi <https://www.frizzifrizzi.it/2023/07/12/tesori-darchivio-i-meravigliosi-insetti-di-seguy/>
* Solved: Tricky Floating Image Alignment – Cloud Four <https://cloudfour.com/thinks/solved-tricky-floating-image-alignment/>
* Animate elements on scroll with Scroll-driven animations - Chrome Developers <https://developer.chrome.com/articles/scroll-driven-animations/>
* Future CSS: Wishes Granted by Scroll-driven Animations <https://kizu.dev/scroll-driven-animations/>
* Tesori d'archivio: i poster cinematografici di Eric Rohman - Frizzifrizzi <https://www.frizzifrizzi.it/2023/07/18/tesori-darchivio-i-poster-cinematografici-di-eric-rohman/>
...
* Library: Accessibility resources, guides, communities, and more <https://www.getstark.co/library/collections/>
* Web Accessibility for Designers: checklist & documentation kit <https://shop.stephaniewalter.design/b/accessibility-interactions-designer-checklist-annotation-kit>
* Resources - We are Colorblind <https://wearecolorblind.com/resources/>
...
* Tesori d'archivio: le più belle tavole del “Kelmscott Chaucer” di William Morris ed Edward Burne-Jones, digitalizzate - Frizzifrizzi <https://www.frizzifrizzi.it/2023/09/20/tesori-darchivio-le-piu-belle-tavole-del-kelmscott-chaucer-di-william-morris-ed-edward-burne-jones-digitalizzate/>
* Canadian Typography Archives <https://www.canadiantypography.ca/>
* THE INDEX <https://theindex.website/>
* Tesori d'archivio: la grafica delle etichette commerciali spagnole della prima metà del '900 - Frizzifrizzi <https://www.frizzifrizzi.it/2023/09/29/tesori-darchivio-la-grafica-delle-etichette-commerciali-spagnole-della-prima-meta-del-900/>
* Tesori d'archivio: le tavole botaniche di A.J. Wendel per un libro dell'800 su fiori e frutti dei Paesi Bassi - Frizzifrizzi <https://www.frizzifrizzi.it/2023/09/25/tesori-darchivio-le-tavole-botaniche-di-a-j-wendel-per-un-libro-dell800-su-fiori-e-frutti-dei-paesi-bassi/>
* Rivalutare il brutalismo, oppure no - Il Post <https://www.ilpost.it/2023/09/18/ritorno-brutalismo/>
* Tesori d'archivio: le illustrazioni botaniche di Arentine Hendrica Arendsen - Frizzifrizzi <https://www.frizzifrizzi.it/2023/10/05/tesori-darchivio-le-illustrazioni-botaniche-di-arentine-hendrica-arendsen/>
* Urban Geometry - Hoxton Mini Press <https://www.hoxtonminipress.com/collections/books/products/urban-geometry>
