...
* CSS reference - CSS: Cascading Style Sheets | MDN <https://developer.mozilla.org/en-US/docs/Web/CSS/Reference#Keyword_index>
...
* File uploader demo <https://massimo-cassandro.github.io/js-file-uploader/demo/>
* massimo-cassandro/m-sharing: Sharing links builder <https://github.com/massimo-cassandro/m-sharing#readme> 
...
* CodePen <http://codepen.io/massimo-cassandro/>
* StackBlitz | Instant Dev Environments | Click. Code. Done. <https://stackblitz.com/>
* PLAYCODE - Javascript Playground <https://playcode.io/>
* npm <https://www.npmjs.com/~massimo-cassandro>
* Visual Studio Marketplace <https://marketplace.visualstudio.com/manage/publishers/mazz>
* Stack Overflow <http://stackoverflow.com/users/743443/max>
* Home page di Microsoft Office <https://www.office.com/?auth=1>
...
* Google Developer Profile <https://developers.google.com/profile/u/108416887201725707657/dashboard>
